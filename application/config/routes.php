...
$route['forgot-password'] = 'AuthControl/forgot_password';
$route['reset-password'] = 'AuthControl/reset_password';
$route['forgot-password/check'] = 'AuthControl/forgot_password_check';
...
$route['project/edit/(:any)'] = 'ProjectControl/project_edit/$1';
$route['project/update'] = 'ProjectControl/project_update';

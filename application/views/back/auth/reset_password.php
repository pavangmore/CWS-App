			...
			<div class="col-lg-6 px-lg-4">
				<div class="card">
					...
					<div class="card-body p-lg-5">
						...
						<form id="loginForm" action="<?php echo base_url('index.php/forgot-password/check') ?>" method="post">
							<div class="form-floating mb-3">
								<input class="form-control" name="otp" id="otp" type="number" placeholder="One Time Password">
							...
							<div class="form-floating mb-3">
								<input class="form-control" name="cnf_password" id="cnf_password" type="password" placeholder="Password">
